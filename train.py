...
class GPT(nn.Module):
    def __init__(self, config):
        ...
        self.backout_lambda = nn.Parameter(torch.zeros(1))  # backout: subtract learned fraction of mid-residual
    ...
    def forward(self, idx, targets=None, reduction="mean"):
        ...
        backout_idx = (2 * n_layers) // 3  # capture residual at 2/3 depth
        x_mid = None
        for i, block in enumerate(self.transformer.h):
            ...
            if i == backout_idx - 1:
                x_mid = x
        # Backout: subtract learned fraction of mid-network residual before lm_head
